...
exports.dialogflowWebhook = functions.https.onRequest(async (request, response) => {
    ...
    //  const unitFIR = coll.child('FIR');
      ...
      await unitFIR.add({ event:crime,date: Date.now(), email:'test@gmail.com',place: place,name: name,age: age,witness: evidence,identification: identity, aadhar,phone: phone, desc , signature:'idxvtn'})
